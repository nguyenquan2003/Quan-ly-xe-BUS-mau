<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteUser.aspx.cs" Inherits="UI_Map_DeleteUser" %>
...
<body>
    ...
    <div class ="content2">
        <div style="margin-left:300px;"><br />
            <div style="font-weight:bold;color:Orange; font-size:20px;margin-top:0px;margin-left:150px;"> Xóa Thông Tin Người Dùng </div>
            <div style="margin-left:30px;margin-top:10px;"> Chọn thông tin người dùng muốn xóa, rồi ấn nút 
                &#39;Xóa bỏ &#39;để xóa thông tin ra khỏi cơ sở dữ liệu.<br /><br />
                <asp:GridView ID="grvUser" runat="server" AutoGenerateColumns="False" 
                    Width="455px"  AllowPaging="True" PageSize="20" 
