<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteBusLine.aspx.cs" Inherits="UI_Map_DeleteBusLine" %>
...
<body>
    ...
    <div class ="content2">
        <div style="margin-left:300px;"><br />
            <div style="font-weight:bold;color:Orange; font-size:20px;margin-top:0px;margin-left:150px;"> Xóa Tuyến Xe Buýt </div>
            <div style="margin-left:30px;margin-top:10px;"> Chọn tuyến xe Buýt muốn xóa, rồi ấn nút 
                &#39;Xóa bỏ &#39;để xóa thông tin ra khỏi cơ sở dữ liệu.<br /><br />
                <asp:GridView ID="grvBusLine" runat="server" AutoGenerateColumns="False" 
                    Width="455px"  AllowPaging="True" PageSize="15" 
                    onpageindexchanging="grvBusLine_PageIndexChanging" 
                    onrowdatabound="grvBusLine_RowDataBound" >
                    <Columns>
                        <asp:BoundField DataField="IDBusLine" HeaderText="Mã tuyến xe">
                        <ControlStyle Width="20px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Name" HeaderText="Tên tuyến xe" />
            ...
            <div style="margin-left:200px;margin-top:10px;">
                    <asp:Button ID="btnDelete" runat="server" Text="Xóa bỏ" Width="67px" 
                        OnClientClick="return DeleteConfirm()" onclick="btnDelete_Click" />
        </div>
        </div>
    </div>
