<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeleteTicketPark.aspx.cs" Inherits="UI_Map_DeleteTicketPark" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Quản lý điểm bán vé tháng</title>
...
<body>
    ...
    <div class ="content2">
        <div style="margin-left:300px;"><br />
            <div style="font-weight:bold;color:Orange; font-size:20px;margin-top:0px;margin-left:150px;"> Xóa Điểm Bán Vé Tháng Xe Buýt </div>
            <div style="margin-left:30px;margin-top:10px;"> Chọn điểm bán vé tháng xe muốn xóa, rồi ấn nút 
                &#39;Xóa bỏ &#39;để xóa thông tin ra khỏi cơ sở dữ liệu.<br /><br />
                <asp:GridView ID="grvTicketPark" runat="server" AutoGenerateColumns="False" 
                    Width="455px"  AllowPaging="True" PageSize="15" 
                    onpageindexchanging="grvTicketPark_PageIndexChanging" 
                    onrowdatabound="grvTicketPark_RowDataBound">
                    <Columns>
                        <asp:BoundField DataField="IDTicketPark" HeaderText="Mã điểm bán vé">
                        <ControlStyle Width="20px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="Name" HeaderText="Tên điểm bán vé" />
