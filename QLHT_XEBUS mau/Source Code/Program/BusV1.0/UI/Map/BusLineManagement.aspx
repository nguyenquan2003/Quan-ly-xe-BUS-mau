<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BusLineManagement.aspx.cs" Inherits="UI_Map_BusLineManagement" %>
    ...
    <div class ="content2">
        <div style="margin-left:300px;" id="div1">
            <asp:Panel ID="pnThemMoi" runat="server" >
                <div style="font-weight:bold;color:Orange; font-size:20px;margin-top:10px;margin-left:150px;"> Thêm mới tuyến xe Buýt </div>
                 <div style="margin-left:30px;margin-top:20px;">   Nhập thông tin vào các ô, chú ý các ô có dấu (<font color="red">*</font>) là bắt buộc phải nhập.
                </div>
