<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditBusParkManagement.aspx.cs" Inherits="UI_Map_EditBusParkManagement" %>
...
<body>
    ...
    <div class ="content2">
        ...
        <ContentTemplate><br />
        <div style="font-weight:bold;color:Orange; font-size:20px;margin-top:0px;margin-left:150px;"> Chỉnh Sửa Bãi Đỗ Xe Buýt </div>
        <div style="margin-left:10px;margin-top:10px;">   Nhập thông tin vào các ô, chú ý các ô có dấu (<font color="red">*</font>) là bắt buộc phải nhập.<br />
        
        <div style="margin-top:20px;"><b>Chọn bãi đỗ xe:&nbsp;&nbsp;&nbsp; &nbsp; </b> <asp:DropDownList ID="drlBusPark" 
                runat="server" Width="250px" AutoPostBack="True" 
                onselectedindexchanged="drlBusPark_SelectedIndexChanged">
            </asp:DropDownList>
        </div><br />
        <div><b>Thông tin bãi đỗ xe: </b><br />
        <div style="margin-left:150px;">
        <asp:HyperLink ID="hpImage" runat="server" Height="240px" Width="270px" 
                            BorderStyle="Dotted" BorderWidth="1px" Font-Italic="True" ForeColor="Blue">[hpImage]</asp:HyperLink>
        </div>
