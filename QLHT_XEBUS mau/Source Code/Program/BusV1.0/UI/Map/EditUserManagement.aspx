<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditUserManagement.aspx.cs" Inherits="UI_Map_EditUserManagement" EnableEventValidation="false" ValidateRequest="false" %>
...
<body>
    ...
    <b>&nbsp; Danh sách người sử dụng:</b><br /><br />
     <div style="margin-left:20px;"><asp:GridView ID="grvUser" runat="server" AllowPaging="True" 
            AutoGenerateColumns="False" PageSize="20" Width="590px" 
