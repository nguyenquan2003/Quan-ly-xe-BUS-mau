<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TicketManagement.aspx.cs" Inherits="UI_Map_TicketManagement" %>
        ...
        <div class="content_left2">
           ...
           <ContentTemplate>
            <asp:Panel ID="pnThemMoi" runat="server" ><br />
                <div style="font-weight:bold;color:Orange; font-size:20px;margin-top:0px;margin-left:150px;"> Thêm Mới Điểm Bán Vé Tháng Xe Buýt </div>
                ...
                <table style="width: 100%; margin-left:10px; margin-top:20px;">
                   ...
                   <tr style="height: 30px;">
                    ...
                    <tr style="height: 30px;">
                        ...
                        <td>
                            <asp:TextBox ID="txtDescription" runat="server" Width="398px" Height="62px" 
